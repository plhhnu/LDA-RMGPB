...
time = 20   //20 times 5-fold CV
k = 5        // k-fold CV
for mm in range(2,3):       // choose dataset
    for cv in range(3, 4):    // choose 5-fold CV strategy(S1, S2, S3 and S4)
        data_file = './data' + str(mm) + '/data21.csv'   // input data
        label_file = './data' + str(mm) + '/label.csv'   // input label
        ...
        for j in range(time):
            ...
            for i in range(k):
                ...
                model1 = gpb.GPBoostClassifier( n_estimators=200, max_depth=9, learning_rate=0.1)
